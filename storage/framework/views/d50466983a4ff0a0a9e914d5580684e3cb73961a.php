  ...
  <body>
    <div class="main-block">
      ...
      <form action="/insert" method="post">
        ...
        <input type="text" name="txtemail" id="email" placeholder="Email" required/>
        <label id="icon" for="name"><i class="fas fa-user"></i></label>
        <input type="text" name="txtname" id="name" placeholder="Username" required/>
...
</html><?php /**PATH D:\MCA_PROJECT_SEM1\PLACMENT\placment\resources\views/signup.blade.php ENDPATH**/ ?>